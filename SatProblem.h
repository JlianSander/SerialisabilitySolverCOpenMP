...
/// <summary>
/// Extends the solution to the specified SAT-Problem
/// </summary>
/// <param name="problem">The SAT-problem, to which the element is to add.</param>
/// <param name="literal">The encoded argument, which is part of the computed extension.</param>
/// <returns>
/// EXIT_SUCCESS iff the operation was succesfull. 
/// EXIT_FAILURE otherwise.
/// </returns>
uint8_t extend_solution(SATProblem_t *problem, int64_t literal);
/// <summary>
